## The agent service principal must be given this role in order to change settings on the PaaS component in a subnet.
...
resource "azurerm_cosmosdb_account" "instancecosmos" {
  ...
  ip_range_filter                   = "46.15.109.71,104.42.195.92,40.76.54.131,52.176.6.30,52.169.50.45,52.187.184.26,193.91.207.187,84.208.135.170,51.105.216.26,81.0.162.113"
